...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JobServiceService = /** @class */ (function () {
                function JobServiceService(http, router) {
                    this.http = http;
                    this.router = router;
                    this.REST_API_URL = "http://localhost:80/jobs";
                }
                JobServiceService.prototype.createJob = function (jobData) {
                    var _this = this;
                    ...
                    var promise = new Promise(function (resolve, reject) {
                        _this.http.post(_this.REST_API_URL, jobData)
                            .toPromise()
                            .then(function (res) {
                            console.log(res);
                            resolve(res);
                ...
                JobServiceService.prototype.getJobById = function (id) {
                ...
                JobServiceService.prototype.getJobBySkill = function (skill) {
                ...
                JobServiceService.prototype.searchJobsByExperience = function (experience) {
                ...
                JobServiceService.prototype.searchJobsBySkillExperience = function (skill, experience) {
                    console.log("id is " + skill);
                    console.log("id is " + experience);
                ...
                JobServiceService.prototype.scheduleInterview = function (job) {
                ...
                JobServiceService.prototype.updateJob = function (jobData) {
                    var _this = this;
                    var _url = this.REST_API_URL + "/" + jobData.jId;
                    console.log(jobData.jobId);
                    var promise = new Promise(function (resolve, reject) {
                        _this.http.put(_url, jobData)
                            .toPromise()
                            .then(function (res) {
                            console.log(res);
                            resolve(res);
                ...
                JobServiceService.prototype.deleteJob = function (jobId) {
                    var _this = this;
                    var _url = this.REST_API_URL + "/" + jobId;
                    var promise = new Promise(function (resolve, reject) {
                        _this.http.delete(_url)
                            .toPromise()
                            .then(function (res) {
                            console.log(res);
                            resolve(res);
                ...
                JobServiceService.prototype.canActivate = function (route, state) {
            ...
            JobServiceService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddjobComponent = /** @class */ (function () {
                function AddjobComponent(rmsService, router) {
                ...
                AddjobComponent.prototype.onAddJobHandler = function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.rmsService.createJob(this.jobPostingForm.value)];
                                case 1:
                                    res = _a.sent();
                                    console.log(res);
                                    if (res) {
            ...
            AddjobComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JobComponent = /** @class */ (function () {
                function JobComponent(jobService, authenticationService, userService, nav, router, route) {
                    var _this = this;
                    ...
                    this.router = router;
                    this.route = route;
                    var _jobId = this.route.snapshot.params.id;
                    this.search = false;
                    this.count = 0;
                ...
                JobComponent.prototype.onAdvancedButtonClick = function () {
                    var _this = this;
                ...
                JobComponent.prototype.onEditHandler = function (id) {
                    var _this = this;
                    this.jobSubscription = this.jobService.getJobById(id)
                        .subscribe(function (res) {
                        console.log(res);
                        _this.duplicateJobData = res;
                        console.log(_this.duplicateJobData.jAppliedCandidateList);
                        if (_this.duplicateJobData.jAppliedCandidateList == "") {
                            _this.isEmpty = true;
                        }
                        else {
                            _this.isEmpty = false;
                ...
                JobComponent.prototype.onInteviewScheduler = function (jId) {
                    var _this = this;
                    this.jobSubscription = this.jobService.getJobById(jId)
                        .subscribe(function (res) {
                        console.log(res);
                        _this.scheduledJob = res;
                        var temp = JSON.parse(JSON.stringify(res));
                        temp.jInterviewDate = _this.scheduleTest.value.date;
                        console.log(temp);
                        _this.jobSubscription = _this.jobService.scheduleInterview(temp)
                            .subscribe(function (res) {
                            console.log(res);
                            _this.scheduledJob = res;
                        });
                ...
                JobComponent.prototype.ongetAppliedCandidatesList = function (id) {
                    var _this = this;
                    this.jobSubscription = this.jobService.getJobById(id)
                        .subscribe(function (res) {
                        console.log(res);
                ...
                JobComponent.prototype.onSearchHandler = function (searchForm) {
                    var _this = this;
                ...
                JobComponent.prototype.onSkillExperienceSearchHandler = function (searchForm) {
                    var _this = this;
                ...
                JobComponent.prototype.onExperienceSearchHandler = function (searchForm) {
                    var _this = this;
                    console.log(searchForm.value.experience);
                    this.experience = searchForm.value.experience;
                    if (this.experience == "") {
                ...
                JobComponent.prototype.onUpdateHandler = function (formData) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var obj, res, _jobId;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    obj = formData.value;
                                    obj.jId = this.jobId;
                                    return [4 /*yield*/, this.jobService.updateJob(this.duplicateJobData)];
                                case 1:
                                    res = _a.sent();
                                    _jobId = this.route.snapshot.params.id;
                ...
                JobComponent.prototype.onDeleteHandler = function (id) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    console.log(id);
                                    return [4 /*yield*/, this.jobService.deleteJob(id)];
                                case 1:
                                    res = _a.sent();
                                    if (res) {
                                        this.isDeleted = true;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var JobdetailComponent = /** @class */ (function () {
                function JobdetailComponent(jobService, route, router) {
                    this.jobService = jobService;
                    this.route = route;
                    this.router = router;
                    this.isSaved = false;
                ...
                JobdetailComponent.prototype.onEditHandler = function () {
                    //duplicating object
                    this.duplicateJobData = JSON.parse(JSON.stringify(this.jobData));
                    console.log(this.duplicateJobData);
                };
                JobdetailComponent.prototype.onUpdateHandler = function (formData) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var obj, res, _jobId;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                ...
                JobdetailComponent.prototype.onDeleteHandler = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _jobId, res;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    _jobId = this.route.snapshot.params.id;
                                    console.log(_jobId);
                                    return [4 /*yield*/, this.jobService.deleteJob(_jobId)];
                                case 1:
                                    res = _a.sent();
                                    if (res) {
                                        this.isDeleted = true;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(formBuilder, route, router, authenticationService, alertService, nav) {
                ...
                LoginComponent.prototype.onLogin = function () {
                    ...
                    this.authenticationService.Hrlogin(this.f.username.value, this.f.password.value)
                        ...
                        var userObj = JSON.parse(JSON.stringify(data));
                        console.log(userObj);
            ...
            var RegisterComponent = /** @class */ (function () {
                ...
                RegisterComponent.prototype.onSubmit = function () {
                    ...
                    this.userService.register(this.registerForm.value)
                        ...
                        _this.router.navigate(['/hrlogin']);
                    }, function (error) {
                        _this.alertService.error('Registration Failed', error);
                        _this.loading = false;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                ...
                AuthenticationService.prototype.Candidatelogin = function (username, password) {
                    var _this = this;
                    ...
                    return this.http.post("http://localhost:80/authenticate", { username: username, password: password }, { headers: headers })
                ...
                AuthenticationService.prototype.Hrlogin = function (username, password) {
                    var _this = this;
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({ Authorization: 'Basic ' + btoa(username + ':' + password) });
                    return this.http.post("http://localhost:80/authenticate", { username: username, password: password }, { headers: headers })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (user) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CandidateService = /** @class */ (function () {
                function CandidateService(http, authenticationService, router) {
                ...
                CandidateService.prototype.createCandidate = function (candidateData) {
                    ...
                    //2.2 send the data using POST method via REST API Client
                    var promise = new Promise(function (resolve, reject) {
                        _this.http.post(_this.REST_API_URL, candidateData)
                            .toPromise()
                            .then(function (res) {
                            console.log(res);
                            resolve(res);
                ...
                CandidateService.prototype.getAllJobsCandidate = function () {
                ...
                CandidateService.prototype.getJobsAppliedByCandidate = function (id) {
                    console.log("id is " + id);
                ...
                CandidateService.prototype.getJobsBySkillCandidate = function (id) {
                    console.log("id is " + id);
                ...
                CandidateService.prototype.getCandidate = function (username) {
                    var _this = this;
                    console.log("inside getcandidate");
                    console.log(username);
                    var name = username;
                    var promise = new Promise(function (resolve, reject) {
                        var temp = _this.http.post(_this.REST_API_URL_DETAILS, name)
                            .toPromise()
                            .then(function (res) {
                            console.log(res);
                            resolve(res);
                ...
                CandidateService.prototype.applyForJobCandidate = function (id, jid) {
                    console.log("id is " + id);
                ...
                CandidateService.prototype.canActivate = function (route, state) {
                    // const currentUser = this.authenticationService.currentUserValue;
                    var currentUser = JSON.parse(localStorage.getItem('currentUser'));
                    console.log(currentUser.authorities[0].authority);
                    console.log(currentUser.role);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CandidateLoginComponent = /** @class */ (function () {
                function CandidateLoginComponent(formBuilder, route, router, authenticationService, alertService, nav, candidateService) {
                    this.formBuilder = formBuilder;
                    this.route = route;
                    this.router = router;
                    this.authenticationService = authenticationService;
                ...
                Object.defineProperty(CandidateLoginComponent.prototype, "f", {
                    // convenience getter for easy access to form fields
                    get: function () { return this.loginForm.controls; },
                    enumerable: true,
                    configurable: true
                });
                CandidateLoginComponent.prototype.onLogin = function () {
                    var _this = this;
                    this.submitted = true;
                    // stop here if form is invalid
                    if (this.loginForm.invalid) {
                    ...
                    this.authenticationService.Candidatelogin(this.f.username.value, this.f.password.value)
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    userObj = JSON.parse(JSON.stringify(data));
                                    console.log(userObj);
                                    if (!(userObj.authorities[0].authority == "ROLE_CANDIDATE")) return [3 /*break*/, 2];
                                    console.log(data);
                                    console.log("Inside candidate login data");
                                    return [4 /*yield*/, this.candidateService.getCandidate(userObj.principal.username)];
                                case 1:
                                    res = _a.sent();
                                    this.candidate = res;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var CandidateRegisterDetailsComponent = /** @class */ (function () {
                function CandidateRegisterDetailsComponent(candidateService, router) {
                    this.candidateService = candidateService;
                    this.router = router;
                    this.skills = ['Java', 'HTML/CSS', 'JavaScript', 'Spring', 'Angular', 'SQL', 'Networking', 'ML', 'C++', 'C'];
                ...
                CandidateRegisterDetailsComponent.prototype.onAddCandidateDetails = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.candidateService.createCandidate(this.candidateDetailsForm.value)];
                                case 1:
                                    res = _a.sent();
                                    console.log(res);
                                    if (res) {
                ...
                CandidateRegisterDetailsComponent.prototype.ngOnInit = function () {
                };
                return CandidateRegisterDetailsComponent;
            }());
            CandidateRegisterDetailsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CandidateRegisterComponent = /** @class */ (function () {
                function CandidateRegisterComponent(formBuilder, router, authenticationService, userService, alertService) {
                    this.formBuilder = formBuilder;
                    this.router = router;
                    this.authenticationService = authenticationService;
                    this.userService = userService;
                ...
                Object.defineProperty(CandidateRegisterComponent.prototype, "f", {
                    // convenience getter for easy access to form fields
                    get: function () { return this.registerForm.controls; },
                    enumerable: true,
                    configurable: true
                });
                CandidateRegisterComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.submitted = true;
                    console.log("Called the Submit");
                    // stop here if form is invalid
                    ...
                    this.userService.register(this.registerForm.value)
                        ...
                        console.log("entered the subscribe");
                        _this.alertService.success('Registration successful', true);
                        _this.router.navigate(['/candidatelogin']);
                    }, function (error) {
                        _this.alertService.error('Registration Failed', error);
                        _this.loading = false;
                    });
            ...
            CandidateRegisterComponent.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LandingComponent = /** @class */ (function () {
                function LandingComponent(authenticationService, nav, router, route, candidateService, http) {
                    var _this = this;
                    this.authenticationService = authenticationService;
                    this.nav = nav;
                    this.router = router;
                ...
                LandingComponent.prototype.onViewAllJob = function () {
                    var _this = this;
                ...
                LandingComponent.prototype.onViewJobHandler = function (jId) {
                    var _this = this;
                ...
                LandingComponent.prototype.onApplyHandler = function (jId) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var name, res;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    name = this.currentUser.principal.username;
                                    console.log(name);
                                    return [4 /*yield*/, this.candidateService.getCandidate(name)];
                                case 1:
                                    res = _a.sent();
                                    this.candidate = res;
                                    console.log(this.candidate);
                ...
                LandingComponent.prototype.showJobByPreference = function (name) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res;
                        var _this = this;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.candidateService.getCandidate(name)];
                                case 1:
                                    res = _a.sent();
                                    this.candidate = res;
                                    this.jobList = null;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var contactReplyService = /** @class */ (function () {
                function contactReplyService(http) {
                    this.http = http;
                    this.REST_API_URL = "http://localhost:80/contactReply";
                }
                contactReplyService.prototype.contactReplyCreate = function (replyForm) {
                    var _this = this;
                    // 1. get the data from the component
                    ...
                    //2.2 send the data using POST method via REST API Client
                    var promise = new Promise(function (resolve, reject) {
                        _this.http.post(_this.REST_API_URL, replyForm)
                            .toPromise()
                            .then(function (res) {
                            console.log(res);
                            resolve(res);
                ...
                contactReplyService.prototype.getContacts = function () {
                    return this.http.get(this.REST_API_URL)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
                        //console.log(res);
                        return res; //Send it back to component
                ...
                return contactReplyService;
            }());
            contactReplyService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var contactServiceService = /** @class */ (function () {
                ...
                contactServiceService.prototype.createContact = function (contactData) {
                    var _this = this;
                    // 1. get the data from the component
                    ...
                    //2.2 send the data using POST method via REST API Client
                    var promise = new Promise(function (resolve, reject) {
                        _this.http.post(_this.REST_API_URL, contactData)
                            .toPromise()
                            .then(function (res) {
                            console.log(res);
                            resolve(res);
                ...
                contactServiceService.prototype.getContacts = function () {
                    return this.http.get(this.REST_API_URL)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
                        //console.log(res);
                        return res; //Send it back to component
                ...
                contactServiceService.prototype.deleteContact = function (id) {
                    var _this = this;
                    console.log(id);
                    var _url = this.REST_API_URL + "/" + id;
                    var promise = new Promise(function (resolve, reject) {
                        _this.http.delete(_url)
                            .toPromise()
                            .then(function (res) {
            ...
            contactServiceService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContactComponent = /** @class */ (function () {
                function ContactComponent(contactServiceService) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    this.submitted = true;
                                    console.log("Called the Submit");
                                    if (!this.contactForm.invalid) return [3 /*break*/, 1];
                                    console.log("invalid");
                                    return [2 /*return*/];
                                case 1: return [4 /*yield*/, this.contactServiceService.createContact(this.contactForm.value)];
                                case 2:
                                    res = _a.sent();
                                    console.log(res);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuerylistComponent = /** @class */ (function () {
                function QuerylistComponent(contactServiceService, route, router) {
                    this.contactServiceService = contactServiceService;
                    this.route = route;
                    this.router = router;
                    this.isSaved = false;
                ...
                QuerylistComponent.prototype.onDeleteHandler = function (id) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var res;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    console.log(id);
                                    return [4 /*yield*/, this.contactServiceService.deleteContact(id)];
                                case 1:
                                    res = _a.sent();
                                    if (res) {
                                        this.isDeleted = true;
                ...
                QuerylistComponent.prototype.ngOnDestroy = function () {
                    console.log("Inside ContactById destroy");
                    this.contactSubscription.unsubscribe();
                };
                return QuerylistComponent;
            }());
            QuerylistComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ReplyComponent = /** @class */ (function () {
                function ReplyComponent(contactReplyService) {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!this.replyForm.invalid) return [3 /*break*/, 1];
                                    console.log("invalid");
                                    return [2 /*return*/];
                                case 1: return [4 /*yield*/, this.contactReplyService.contactReplyCreate(this.replyForm.value)];
                                case 2:
                                    res = _a.sent();
                                    console.log(res + "hii");
                                    //2. get the resp from service
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeImageComponent = /** @class */ (function () {
                function HomeImageComponent(nav) {
                    this.nav = nav;
                }
                HomeImageComponent.prototype.ngOnInit = function () {
                    this.nav.hide();
                };
                return HomeImageComponent;
            }());
            HomeImageComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _nav_nav_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../nav/nav.service */ "./src/app/component/nav/nav.service.ts");
            var LoginLandingComponent = /** @class */ (function () {
                function LoginLandingComponent(nav) {
                    this.nav = nav;
                }
                LoginLandingComponent.prototype.ngOnInit = function () {
                    this.nav.hide();
                };
                return LoginLandingComponent;
            }());
            LoginLandingComponent.ctorParameters = function () { return [
                { type: _nav_nav_service__WEBPACK_IMPORTED_MODULE_2__["NavService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavComponent = /** @class */ (function () {
                function NavComponent(translate, router, nav, authenticationService) {
                    var _this = this;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavService = /** @class */ (function () {
                ...
                NavService.prototype.doSomethingElseUseful = function () { };
                return NavService;
            }());
